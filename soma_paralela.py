...
def soma_paralela(arquivo, num_proc):
    ...
    print("=== SOMA PARALELA (Python multiprocessing) ===")
...
if __name__ == "__main__":
    if len(sys.argv) < 3:
        print("Uso: python soma_paralela.py <arquivo> <num_processos>")
        sys.exit(1)
    soma_paralela(sys.argv[1], int(sys.argv[2]))
